...
class ATATFeatures(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        self.embedding_tab = nn.Embedding(num_features + num_metadata, kwargs.get("embedding_size", 64))
    ...
    def _process_metadata(self, metadata=None, features=None, period=None, features_info=None, metadata_info=None, tabular_mask=None):
        """
    ...
    def forward(self, metadata=None, features=None, features_info=None, metadata_info=None,tabular_mask=None, **kwargs):
        """
